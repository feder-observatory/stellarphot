...
def photutils_stellar_photometry(ccd_image, sources, aperture_radius, inner_annulus
    ...
    if inner_annulus > outer_annulus:
        raise ValueError("outer_annulus must be greater or equal inner_annulus")
    ...
    n_pix_ap = math.pi * (aperture_radius**2)
    n_pix_ann = math.pi * ((outer_annulus**2) - (inner_annulus**2))
